...
# even though BSD ls uses the LSCOLORS version above, export this one
# on OS X as well so we can reuse this for zsh completion and get the same
# coloring for file/directory name completion
